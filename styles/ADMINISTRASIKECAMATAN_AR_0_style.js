...
var style_ADMINISTRASIKECAMATAN_AR_0 = function(feature, resolution){
    ...
    var value = feature.get("jumlah penduduk");
    var labelText = "";
    size = 0;
    ...
    if (value > 3519.000000 && value <= 4731.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 4731.000000 && value <= 5943.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 5943.000000 && value <= 7155.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 7155.000000 && value <= 8367.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 8367.000000 && value <= 9579.000000) {
            style = [ new ol.style.Style({
